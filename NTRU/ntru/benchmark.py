...
for i in range(number_of_test):
    ...
    b = time.time()
    enc = NTRU2.encrypt("test", "5962860319758416")
...
print(f"Key generation: {round(a1, 6)}s")
print(f"Encryption: {round(a2, 6)}s")
print(f"Decryption: {round(a3, 6)}s\n")
# print(a1, a2, a3)
...
b3 = middle(l31)
print("High Security:")
print(f"Key generation: {round(b1, 6)}s")
print(f"Encryption: {round(b2, 6)}s")
print(f"Decryption: {round(b3, 6)}s\n")
# print(b1, b2, b3)
...
print(f"Key generation: {round(c1, 6)}s")
print(f"Encryption: {round(c2, 6)}s")
print(f"Decryption: {round(c3, 6)}s\n")
# print(c1, c2, c3)
